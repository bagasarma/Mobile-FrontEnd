...
class _M09State extends State<M09> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      setState(() {
        bottomSheetTampil = _tabController.index == 1; // Tab BottomSheet memiliki index 1
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          // Hanya tampilkan title ketika tab Drawer yang aktif (bottomSheetTampil = false)
          title: bottomSheetTampil ? null : const Text('Implementasi Drawer'),
            ...
            children: [
              ...
              ListTile(
                onTap: () {
                  ...
                  _tabController.animateTo(0); // Pindah ke tab Drawer
                  Navigator.pop(context);
                },
